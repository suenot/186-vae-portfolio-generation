...
Генерация синтетических портфелей с помощью VAE.
...
1. **Deep Generative Models for Synthetic Financial Data**
   - URL: https://arxiv.org/abs/2512.21798
   - Год: 2024

## Структура
```
239_vae_portfolio_generation/
├── README.specify.md
├── docs/ru/
├── python/
└── rust/src/
